...
export const mount = (host, port, notices) => {
  ...
  said.textContent = 'A stage face. It can be moved between panes and tabs without knowing it was moved.';
  ...
  if (port && typeof port.get_healthz === "function") {
    const asked = doc.createElement("p");
    asked.className = "demo-asked";
    asked.textContent = "asked the membrane for healthz";
    box.append(asked);
    port.get_healthz();
  }
