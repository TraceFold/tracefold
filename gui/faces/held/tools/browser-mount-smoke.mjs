...
// node:fs the module graph would fail to resolve in the browser and this would
// report SMOKE_MESSAGES.IMPORT_FAILED instead of a screenshot -- the negative
// control req/02 W15's AC column asks for.
...
<head>
<meta charset="utf-8">
<title>W15 real-browser mount smoke -- held face</title>
...
/** A plain static file server over the project root, the same server faces/ledger's
 * own smoke starts -- reused here as a fresh instance because the port and its
 * lifetime belong to this run, not shared across a process boundary. */
